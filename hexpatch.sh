...
var=`if ! $IS64BIT || [[ $API -le 25 ]]; then echo 2; elif $qcom && [[ $API -ge 28 ]]; then echo 3; else echo 1; fi`

hex=( \
# default
[132]=........f9031f2af3031f2a41000014 [1132]=1f2003d5f9031f2af3031f2a48000014 \
